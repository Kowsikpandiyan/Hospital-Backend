...
const addPrescription = async (req, res) => {
    try {
        const { appointmentId, prescription, docId } = req.body
        ...
        if (!appointment.isCompleted) {
            return res.json({ success: false, message: "Complete the appointment first" })
        }
...
// API to get prescription for doctor
...
// NEW: API to make all doctors available
const makeAllDoctorsAvailable = async (req, res) => {
    try {
...
export {changeAvailablity,doctorList,loginDoctor,appointmentsDoctor,appointmentCancel,appointmentComplete,doctorDashboard,doctorProfile,updateDoctorProfile,addPrescription,getPrescription,makeAllDoctorsAvailable}
